...
%Some phase transitions arise  for the central limit theorems in the sense 
...
We write  $g = g_0 + g_1$ with $g_0 \in \mathcal C_s \oplus \mathcal C_c$ and $g_1 \in \mathcal C_l$,  and $q_f:=Z_1f - \langle Z_1f, \varphi \rangle\in \mathcal P^*$ for each $f\in \mathcal P$.
  ...
  \[
    ...
    %\langle g_1, \phi_p \rangle e^{-(\alpha \tilde \beta - |p|b)s} \phi_p.
    \langle g_1, \phi_p \rangle_\varphi e^{-(\alpha \tilde \beta - |p|b)s} \phi_p.
  \]
  Notice that the second term is in $C_\infty(\mathbb R^d)\cap \mathcal P$ since it is a finite %summation of polynomials, 
  sum of polynomials, 
  and the first term is also in $C_\infty (\mathbb R^d) \cap \mathcal P$ according to \cite[Fact 1.1]{MarksMilos2018CLT}.
...
eigenvalue $-|p|b$ and $ H_t^p =e^{-(\alpha-|p|b)t}X_t(\phi_p)$ for each $t\geq 0$.
