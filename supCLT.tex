...
%term of the spectral decomposition of $f$ in terms of the spectrum of the the mean semigroup of $X$. 
...
%Suppose $\mu\in \mathcal M_c(\mathbb R_d)$ has compact support.
...
%    for any $\gamma\in (0, \beta)$, as $t\rightarrow \infty$
...
\subsection{}
 ...
 %Denote by $\mathcal{M}_c(\mathbb{R}^d)$ by the space of all finite Borel measures on $\mathbb{R}^d$ with compact support.
...
%    Then the process $(M_t^{f,a})_{t\geq 0}$ is an $(\mathscr F_t)$-martingale.
...
%    Hence, for each $\gamma \in (0,\beta)$, 
...
%Let $f\in \mathcal{P}$ and $\Theta>0$. 
Let $f\in \mathcal{P}$, and $\Theta >0$ and $\mu\in \mathcal M_c(\mathbb R^d)$.
Assume that $\alpha\beta\leq\kappa_fb(1+\beta)$. Then there exist $C,\delta>0$ such that for all $T\geq 0$, $n \in \{0,...,\lfloor t \rfloor\}$ and $(\theta_0,...,\theta_n)\in \mathbb{R}^{n+1}$ satisfying $|\theta_i|\leq \Theta$, we have
\begin{align}
\label{32corollary}
