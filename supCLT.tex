%%%----Versions-----------------------------
% supCLT6.tex 2018/11/29 by Zhenyao
...
\begin{proof}
    ...
    For each $\kappa \in \mathbb Z_+$, each $0\leq r\leq s\leq t$ with $s-r \leq 1$, each $g\in \mathcal P$ with $Q_k g \leq h$ and each $c>0$, we have
\begin{align}
...
\subsection{Proof of Theorem \ref{Theorem12}}
    ...
    \end{align*}
    Then according to Lemma \ref{lem: control of Wt} and Lemma \ref{lem: control of AT}, there exist $C,\delta>0$, such that (\added{\bf Zhenyao: I dont get this, why not use Lemma 2.5?})
    \begin{align*}
