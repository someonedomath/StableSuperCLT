...
\begin{equation}\begin{split}\label{CSBP}
...
\]
    Recall that the extinction probability of the superprocess is $\mathbb{P}_{\mu}(D)=e^{-\bar v\|\mu\|}$, where $\bar v=\alpha^{1/\beta}$ is the larger root of $\psi(z)=0$.
...
\begin{equation}\begin{split}
    ...
    =\frac{ \mathbb P_\mu[e^{-\lambda \|X_t\| }(1-e^{-\bar v\|X_t\|})] }{\mathbb P_\mu(D^c)}
    \\&=\frac{e^{-\|\mu\|v_t(\lambda)}-e^{-\|\mu\|v_t(\lambda+\bar v)}}{1-e^{-\|\mu\|\bar v}}
    \leq \frac{\|\mu\|}{1-e^{-\|\mu\|\bar v}}\left|v_t(\lambda)-v_t(\lambda+\bar v)\right|.
\end{split}\end{equation}
...
\begin{align*}
    ...
    &\leq \frac{\|\mu\|}{1-e^{-\|\mu\|\bar v}}e^{\lambda f(t)}\left|v_t(\lambda)-v_t(\lambda+\bar v)\right|.
\end{align*}
	Let $w_t(\lambda)=\alpha \lambda^{-\beta}e^{-\alpha \beta t}+1-e^{-\alpha\beta t}$, then $v_t(\lambda)=\alpha^{1/\beta}w_t(\lambda)^{-1/\beta}$.
Note that
\begin{align*}
    \left|v_t(\lambda)-v_t(\lambda+\bar v)\right|&\leq\frac {\alpha^{1/\beta}}{\beta} \left|w_t(\lambda)-w_t(\lambda+\bar v)\right| \sup_{s\in [\lambda,\lambda+\bar v]}w_t(s)^{-1/\beta-1}\\
    &\leq  \frac{\alpha^{1/\beta+1}}{\beta}\left|\frac{1}{\lambda^{\beta}}-\frac{1}{(\lambda+\bar v)^{\beta}}\right|e^{-\alpha\beta t} \sup_{s\in [\lambda,\lambda+\bar v]}w_t(s)^{-1/\beta-1}\\
    &\leq  \frac{\alpha^{1/\beta+1}}{\beta}\frac{2}{\lambda^{\beta}}e^{-\alpha\beta t} \sup_{s\in [\lambda,\lambda+\bar v]}w_t(s)^{-1/\beta-1}.
\end{align*}
...
\label{eq: inequality before take lambda}
    ...
    \leq C_0e^{\lambda f(t)}\frac{1}{\lambda^{\beta}}e^{-\alpha\beta t} \sup_{s\in [\lambda,\lambda+\bar v]}w_t(s)^{-1/\beta-1}.
\end{split}\end{equation}
...
\begin{align*}
    \sup_{s\in [\lambda,\lambda+\bar v]}w_t(s)^{-1/\beta-1}
    &\leq\sup_{s\in [\lambda,\lambda+\bar v]}\frac{s^{1+\beta}e^{\alpha(1+\beta)}}{\alpha^{1/\beta +1}}+\frac{1}{(1-e^{-\alpha\beta })^{1/\beta+1}}\\
    &\leq \frac{(1+\bar v)^{1+\beta}e^{\alpha(1+\beta)}}{\alpha^{1/\beta+1}}+\frac{1}{(1-e^{-\alpha\beta })^{1/\beta+1}} =: C_1.
\end{align*}
Finally, plugging $\lambda = f(t)^{-1} \in (0,1]$
